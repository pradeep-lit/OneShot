...
**Getting OneShot**
 ```
 cd ~
 wget https://raw.githubusercontent.com/pradeep-lit/OneShot/master/oneshot.py
 ```
Optional: getting a list of vulnerable to pixie dust devices for highlighting in scan results:
 ```
 wget https://raw.githubusercontent.com/pradeep-lit/OneShot/master/vulnwsc.txt
 ```
## Arch Linux
**Installing requirements**
 ```
 ...
 **Getting OneShot**
 ```
 sudo wget https://raw.githubusercontent.com/pradeep-lit/OneShot/master/oneshot.py
 ```
Optional: getting a list of vulnerable to pixie dust devices for highlighting in scan results:
 ```
 sudo wget https://raw.githubusercontent.com/pradeep-lit/OneShot/master/vulnwsc.txt
 ```
